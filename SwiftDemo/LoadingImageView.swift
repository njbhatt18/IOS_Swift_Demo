...
public final class LoadingImageView : UIView {
    public var isDownloadComplete = false as Bool
...
//  }
  ...
  func updateProgressLayer(forState state: LoadingImageState, progress: Float) {
    ...
    case .Downloading(_):
      ...
      progressLayer.path = UIBezierPath(roundedRect: bounds, cornerRadius: CGFloat(inset)).CGPath
  ...
  //MARK: Network Calls
    public func checkDownloadIsComplete () ->Bool{
