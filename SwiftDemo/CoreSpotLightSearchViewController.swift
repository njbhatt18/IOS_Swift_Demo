...
class CoreSpotLightSearchViewController: UIViewController,UITextFieldDelegate {
    ...
    @IBAction func AddItemToCoreSpotlight(sender: AnyObject) {
        ...
        attributeSet.contentDescription = "Swift Demo"
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title="CoreSpotLight Search"
